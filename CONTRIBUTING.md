...
1. Fork `https://github.com/3blades/cli-tools` repository to your user organization.
1. Clone your copy of `https://github.com/your-username/cli-tools` onto your machine using
`git clone https://github.com/your-username/cli-tools`.
1. Specify a new remote upstream repository that will be synced with the fork: `git remote add upstream https://github.com/3blades/cli-tools`.
